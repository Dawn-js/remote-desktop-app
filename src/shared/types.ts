...
export interface IPCHandlers {
  'ssh:create-session': (data: SSHSessionData) => Promise<{ success: boolean; sessionId?: string; error?: string }>;
  ...
  'local:create-terminal': (data: LocalTerminalData) => Promise<{ success: boolean; sessionId?: string; error?: string }>;
...
export type ElectronAPI = {
  ssh: {
    createSession: (data: SSHSessionData) => Promise<{ success: boolean; sessionId?: string; error?: string }>;
  ...
  local: {
    createTerminal: (data: LocalTerminalData) => Promise<{ success: boolean; sessionId?: string; error?: string }>;
    sendInput: (sessionId: string, data: string) => Promise<void>;
    resize: (sessionId: string, cols: number, rows: number) => Promise<void>;
